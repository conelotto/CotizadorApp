...
"use strict";
	...
	function setup($) {
		...
		$.blockUI.defaults = {
			...
			message:  '<img src="../../Images/ajax-loader.gif" style ="padding-top:15px" /><h3 style ="padding-bottom:15px">Por favor, espere</h3>',

			title: 'Por favor, espere',	  // title string; only used when theme == true
