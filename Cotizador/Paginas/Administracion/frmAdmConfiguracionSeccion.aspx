<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="frmAdmConfiguracionSeccion.aspx.vb" Inherits="Cotizador.frmAdmConfiguracionSeccion" %>
...
<table class="ToolbarTituloRedondeado" width="100%" cellpadding="0" border="0" cellspacing="0" >
        <tr>
            <td style ="text-align:left" class="TextoTitulo" >
               <asp:Label ID="lblTitulo" runat="server" Text="Archivo de Sección y Sub Sección"  ></asp:Label>
            </td>
    ...
    <div class ="divHeadTitle100"> Busqueda </div>
        ...
        <div style ="padding-bottom:5px; ">
           <span> &nbsp; &nbsp; Sección &nbsp; &nbsp; &nbsp;:</span>  <select id="cbSeccion" style ="width:30%">
            </select>
        </div>
    </div>
    <table >
    ...
    <script type="text/javascript" language ="javascript" >
        ...
        $(document).ready(function () {
            ...
            $("#jqgCriterio").jqGrid({
                ...
                height: 300,
                width: (valwidth * 0.15),
                colNames: ['Ide', 'IdCriterio', 'Tipo', 'Nombre', 'CodigoSeccion'],
                colModel: [
                            { name: 'Ide', hidden: true },
                            { name: 'IdCriterio', hidden: true },
                            { name: 'Tipo', hidden: true },
                            { name: 'Nombre', width: 140, sorttype: "string" },
                            { name: 'CodigoSeccion', width: 140, sorttype: "string", hidden: true }
   	                    ],
                rowNum: 10,
                rowList: [10, 20, 30],
                pager: '#pagerModelo',
                ...
                sortorder: "desc",
                caption: "Criterios",
                onSelectRow: function (rowId, a, b) {
                    LimpiarBusqueda();
            ...
            var menu = "<table><tr><td style='vertical-aling: middle'>"
            menu = menu + " <div id='divMantenimiento' style ='float:left;width:140px' > <a id='lblNuevo'>Nuevo</a> | <a id='lblEditar'>Editar</a>| <a id='lblELiminar'>Eliminar</a></div>"
            menu = menu + "<div id='divMarcador'style ='float:left' > | <a id='lblMarcadores'>Marcadores</a></div>"
            menu = menu + "<div id ='divBusqueda'> | <a id='lblBuscar'>Buscar</a>| <a id='lblListar'>Mostar todos</a></div>"
            menu = menu + "</td></tr></table>";

            $('#t_jqgConfiguracion').append(menu);
        ...
        function ListarSeccion() {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    var lista = data.d;
                    $('#cbSeccion').append('<option value="0" selected="selected"> </option>')
        ...
        function CriterioPorSeccion(IdSeccion) {
            ...
            $('#divMantenimiento').css('visibility', 'visible');
            $('#divMantenimiento').css('width', '140');
            $('#divMarcador').css('visibility', 'visible');
            $('#divMarcador').css('width', '80');
                        ...
                        for (var i = 0; i < lista.length; i++) {
                            ...
                            var mydata = [
                                { Ide: lista[i].IdSeccionCriterio,
                                    ...
                                    CodigoSeccion: lista[i].CodigoSeccion
                                }
                            ];
        ...
        function paginacionConfiguracion() {
            ...
            switch (reg.CodigoSeccion)
            {
                case '004':
                    $('#divMantenimiento').css('visibility', 'hidden');
                    $('#divMarcador').css('visibility', 'hidden');

                    $('#divMantenimiento').css('width', '0');
                    $('#divMarcador').css('width', '0');
                break;
