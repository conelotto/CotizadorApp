...
Public Class frmAdmEspecificacionTecnica
    ...
    Public Shared ReadOnly Property UrlCarpetaFTP() As String
        ...
        End Get
    End Property
    Private Shared _IdSeccion As Integer = Modulo.strCodSeccionEspecifTecnica    '64
    ...
    Public Shared Function ListarSeccion() As List(Of beTablaMaestra)
        ...
        listaReturn = lista.Where(Function(c) c.IdSeccion = _IdSeccion).ToList
    ...
    Public Shared Function GuardarMantenimiento(ByVal Accion As String, _
        ...
        If Not String.IsNullOrEmpty(Archivo) Then
            If CargarArchivo.ToUpper().Trim = "SI" Then
                Dim strMensajeSubir As String = SubirArchivoTemporal(Archivo)
    ...
    End Function
    Private Shared Function SubirArchivoTemporal(ByVal NombreArchivoDestino As String) As String
        ...
        Try
            ...
            Dim NombreArchivoOrigen As String = "Temp.docx"

            strMesanje = oAdminFTP.CopiarFichero(urlOrigen, urldestino, NombreArchivoOrigen, NombreArchivoDestino)
